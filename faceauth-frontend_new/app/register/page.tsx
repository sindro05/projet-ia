...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const result = await registerUser(name.trim(), photo);
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-400">
              Enregistrez votre nom et votre visage pour créer
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.05] p-6 shadow-2xl backdrop-blur-xl sm:p-8">
            ...
            {/* Security indicator */}
            <div className="mb-7 flex items-center gap-3 rounded-2xl border border-cyan-400/10 bg-cyan-400/5 p-4">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-slate-400">
                  Votre visage sera utilisé pour vérifier votre identité.
                </p>
              </div>
            ...
            >
              ...
              {/* Information */}
              <div className="flex gap-3 rounded-2xl border border-blue-400/10 bg-blue-400/5 p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-400">
                    Utilisez une photo nette, bien éclairée et assurez-vous
                    qu&apos;un seul visage est visible.
                  </p>
                </div>
